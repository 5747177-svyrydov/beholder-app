...
Проект Beholder — це інструментарій комп'ютерного зору (CV) для створення матеріальних контролерів для інтерактивних комп'ютерних систем. 
...
Подробиці налаштування блоків файл-скрипту - Guide.md
...
- символ l через нахил маркеру вліво.
